...
public class NMSHandler_1_13_R1 extends NMSHandler
{
	public List<Material> excludedMaterials = new ArrayList<Material>(
			...
			Material.HORN_CORAL, Material.HORN_CORAL_FAN, Material.TUBE_CORAL, Material.TUBE_CORAL_FAN, Material.DEAD_BRAIN_CORAL_BLOCK,
			Material.DEAD_BRAIN_CORAL_FAN, Material.DEAD_BUBBLE_CORAL_BLOCK, Material.DEAD_BUBBLE_CORAL_FAN, Material.DEAD_FIRE_CORAL_BLOCK,
			Material.DEAD_FIRE_CORAL_FAN, Material.DEAD_HORN_CORAL_BLOCK, Material.DEAD_HORN_CORAL_FAN, Material.DEAD_TUBE_CORAL_BLOCK,
