...
public class NMSHandler_1_16_R2 extends NMSHandler {
	public List<Material> excludedMaterials = new ArrayList<Material>(
			...
			Material.STRUCTURE_VOID, Material.SUGAR_CANE, Material.TNT, Material.TRIPWIRE, Material.TRIPWIRE_HOOK, Material.WARPED_FUNGUS, Material.CRIMSON_FUNGUS,
			Material.HONEY_BLOCK, Material.NETHER_SPROUTS, Material.CRIMSON_ROOTS, Material.WARPED_ROOTS, Material.TWISTING_VINES_PLANT, Material.WEEPING_VINES_PLANT));
