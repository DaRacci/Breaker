...
public class NMSHandler_1_16_R3 extends NMSHandler {
	...
	public Sound getBlockBreakSound(org.bukkit.block.Block block) {
		try {
			...
			Field breakSound = SoundEffectType.class.getDeclaredField(Settings.instance().useMappedReflection() ? "breakSound" : "X");
	...
	public List<Material> getExlcudedBlocks() {
		for (Material m : Material.values())
			if (m.name().contains("POTTED")) excludedMaterials.add(m);
